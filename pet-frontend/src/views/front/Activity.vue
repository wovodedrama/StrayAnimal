<template>
  <div class="home-container" style="min-height: calc(100vh - 60px); margin: 10px 0">
    ...
    <el-dialog title="信息" :visible.sync="dialogFormVisible" width="60%"   class="modern-dialog"  top="5vh"  :close-on-click-modal="false">
      <el-form label-width="100px" size="small" class="dialog-form">
        ...
        <el-form-item label="时间"  class="form-item__gradient">
          <el-date-picker v-model="form.time" type="datetime" value-format="yyyy-MM-dd HH:mm:ss" placeholder="选择日期时间"></el-date-picker>
        </el-form-item>
        <el-form-item label="报名人数"  class="form-item__gradient">
          <el-input v-model="form.num" autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item label="地址"  class="form-item__gradient">
          <el-input v-model="form.address" autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item label="内容"  class="form-item__gradient">
