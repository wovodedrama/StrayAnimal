...
import com.kaze.pet.service.ISalvationService;
import com.kaze.pet.entity.Salvation;
...
public class SalvationController {
    ...
    */
    ...
    public void export(HttpServletResponse response) throws Exception {
        // 从数据库查询出所有的数据
        List<Salvation> list = salvationService.list();
        // 在内存操作，写出到浏览器
        ...
        String fileName = URLEncoder.encode("Salvation信息表", "UTF-8");
    ...
    public Result imp(MultipartFile file) throws Exception {
        ...
        List<Salvation> list = reader.readAll(Salvation.class);

        salvationService.saveBatch(list);
        return Result.success();
    }
